...
$sql = 'SELECT club_id, shortname from club WHERE '.$sWHEREregion;
...
//		$exp_dir = DDIR_CLUBS.'/'.$rs2->fields["shortname"];
		$exp_dir = DDIR_CLUBS;		
		$exp_file = 'V_'. $rs2->fields["shortname"] .'_Heimspielplan';
	...
	$myxls->headerline[1]="Heimspielplan für ".$rs2->fields["shortname"];
	$sql2 = 'SELECT l.shortname, g.game_no, g.game_team_home, g.game_team_guest, g.game_date, g.game_time, g.game_gym, g.game_team_ref1,g.game_team_ref2 FROM game g, league l WHERE club_id='.$rs2->fields["club_id"].' AND g.league_id=l.league_id ORDER BY g.game_date, g.game_gym, g.game_time';
