...
//		$exp_dir = DDIR_CLUBS.'/'.$rs->fields["shortname"];		
		...
		fputs($file,"<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\"".
				...
				"<head>".
				"<title>HBV ".$_SESSION['CONFIG_region']." - Heimspielplan ".$rs->fields["shortname"]." - ".$_SESSION['CONFIG_season']."</title>".
				...
				"</tr><tr></tr><tr>".
				"<th align=\"left\" width=\"60%\">Heimspielplan für ".$rs->fields["name"].
