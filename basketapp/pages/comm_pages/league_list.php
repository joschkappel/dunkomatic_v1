...
$actions_arr=array();
$actions_arr[]=array("type"=>"M","action"=>"delete_all","heading"=>"Mail verfassen","onclick"=>$obj_name."_perform_action('mail')","row_end"=>false);
...
//$in_table_actions_arr[]=array("type"=>"R","heading"=>"Mails","action"=>"mails()","image"=>'usrlist');


$dont_show_radio=false;
