...
if (isset($_REQUEST["schedule_".$primary_object["id_column_name"]."_selected"]))
{
	$_SESSION["security_group_id_selected_session"]=$_REQUEST["schedule_".$primary_object["id_column_name"]."_selected"];
	$primary_object_selected_id=$_REQUEST["schedule_".$primary_object["id_column_name"]."_selected"];
