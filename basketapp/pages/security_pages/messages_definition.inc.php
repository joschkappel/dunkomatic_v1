...
$form_field6=new form_textarea_field("setting_value");
$form_field6->set_show_in_list(true);
$form_field6->set_rows(10);
$form_field6->set_cols(120);
...
$form_field7->set_show_in_edit(false);
...
$form_field9->set_date_format(DATE_FORMAT_SHORT);
$form_field9->set_show_in_edit(true);
