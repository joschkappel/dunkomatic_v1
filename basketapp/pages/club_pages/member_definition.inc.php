...
$form_field2->set_list_id_values($member_role_ids_club_array);
$form_field2->set_list_display_values($member_role_values_club_array);
...
$form_field14->set_date_format(DATE_FORMAT_SHORT);
