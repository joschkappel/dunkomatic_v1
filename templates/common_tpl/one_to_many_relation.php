                ...
                ?>
                    <form method="get" name="pager_search" action="" class="GeneralForm">
                        <table cellspacing="0">
                            ...
                            ?>
                                <tr>
                                    <td colspan="5"><?php if ($where_search) echo $where_search;
                                                    else echo "&nbsp;"; ?></td>
                                </tr>
                            <?php
                            }
					...
					if ($sec_level > 2) {
                                                ...
                                                <a href="javascript:<?php echo $obj_name ?>_select_object('<?php echo $rs->fields[$id_column_name]  ?>','<?php echo $rs->fields["shortname"]  ?>');<?php echo $in_table_action["action"] ?>">
                                                    ...
                                                    ?><td bgcolor="<?php echo $bgcolor; ?>">&nbsp;</td><?php
                                                                    ...
                                                                    ?><td <?php echo $click_mouse; ?> bgcolor="<?php echo $bgcolor; ?>" dir="<?php echo $field->lang_dir ?>"><?php if ($rs->fields[$field->name]) echo html_entity_decode($rs->fields[$field->name]);
                                                                                                                                                                                                    else echo "&nbsp;"; ?></td><?php
                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                ?><td <?php echo $click_mouse; ?> bgcolor="<?php echo $bgcolor; ?>"><input type="text" name="<?php echo $field->name . '_' . $rs->fields[$id_column_name] ?>" class="<?php echo $field->css_class ?>" value="<?php echo $rs->fields[$field->name] ?>" dir="<?php echo $field->lang_dir ?>"></td><?php
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    if ($field->type == "url") {
                                                                                                                                                                                                                                                                                                            ?><td bgcolor="<?php echo $bgcolor; ?>"><a href="<?php echo $field->protocol;
                                                                                                                                                                                                                                                                                                        if ($rs->fields[$field->name]) echo html_entity_decode($rs->fields[$field->name]);
                                                                                                                                                                                                                                                                                                        else echo "&nbsp;"; ?>" target="_blank"><?php if ($rs->fields[$field->name]) echo html_entity_decode($rs->fields[$field->name]);
                                                                                                                                                                                                                                                                                                        else echo "&nbsp;"; ?></a></td><?php
                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                if ($field->type == "url_text") {
                                                                                                                                                                                                                                                                                                                                                    ?><td bgcolor="<?php echo $bgcolor; ?>"><a href="<?php echo $field->protocol;
                                                                                                                                                                                                                                                                                                                                                    if ($rs->fields[$field->name]) echo html_entity_decode($rs->fields[$field->name]);
                                                                                                                                                                                                                                                                                                                                                    else echo "&nbsp;"; ?>" target="_blank"><?php echo $field->text_field_name; ?></a></td><?php
                                                                                                                                                                                                                                                                                                                                                }


                                                                                                                                                                                                                                                                                                                                                if ($field->type == "hidden") {
                                                                                                                                                                                                                                                                            ?><td class="<?php echo $field->css_class ?>" dir="<?php echo $field->lang_dir ?>"><?php if ($rs->fields[$field->name]) echo html_entity_decode($rs->fields[$field->name]);
                                                                                                                                                                                                                                                                                                                                                    else echo "&nbsp;"; ?></td><?php
                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                if ($field->type == "checkbox") {
                                                                                                                                                                                                                        ?><td bgcolor="<?php echo $bgcolor; ?>" dir="<?php echo $field->lang_dir ?>"><?php if ($rs->fields[$field->name]) echo YES;
                                                                                                                                                                                                                                                                                                                                                    else echo NO; ?></td><?php
                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                if ($field->type == "datetime") {
                                                                                                                                                                                                                                                                                                                                                    if (!$field->edit_in_list) {
                                                                                                                                                                    ?><td <?php echo $click_mouse; ?> bgcolor="<?php echo $bgcolor; ?>" dir="<?php echo $field->lang_dir ?>"><?php if (format_from_db_date($rs->fields[$field->name], $field->date_format, $field->date_type)) echo format_from_db_date($rs->fields[$field->name], $field->date_format, $field->date_type);
                                                                                                                                                                                                                                                                                                                                                        else echo "&nbsp;" ?></td><?php
                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                    ...
                                                                                                    ?><td <?php echo $click_mouse; ?> bgcolor="<?php echo $bgcolor; ?>"><?php if ($list_value) echo $list_value;
                                                                                                                                                                                                                                                                                                                                                                        else echo "&nbsp;" ?></td><?php
                                                                                                                                                                                                                                                                                                                                                                    }
                                ...
                                if ($show_checkboxes or !$dont_show_radio) {
                                    if (isset($actions_arr)) {
                                        ...
                                        foreach ($actions_arr as $action) {
                                            if ($action["action"] == "select_all") { ?><a href="javascript:<?php echo $action["onclick"] ?>"><?php echo $action["heading"] ?></a><?php
                                                                                                    }
                                                                                                }


                                                                                                foreach ($actions_arr as $action) {
                                                                                                    if ($action["action"] == "clear_all") { ?> / <a href="javascript:<?php echo $action["onclick"] ?>"><?php echo $action["heading"] ?></a><?php
                                                                                                        }
                                                                                                    }
                        ...
                        <tr>
                            <td></td>
                            <td colspan="8"> ausgewählte Einträge: <?php

                                                                                                        foreach ($actions_arr as $action) {
                                                                                                            if ($action["action"] == "delete_all") { ?><input type="button" name="btn_<?php echo $action['heading']  ?>" onclick="<?php echo $action["onclick"] ?>" value="<?php echo $action["heading"] ?>" /><?php
                                                                                                                                                                    }
                                                                                                                                                                }

                                                                                                                                                                foreach ($actions_arr as $action) {
                                                                                                                                                                    if ($action["action"] == "update_all") { ?><input type="button" name="btn_<?php echo $action['heading']  ?>" onclick="<?php echo $action["onclick"] ?>" value="<?php echo $action["heading"] ?>" /><?php
                                                                                                                                                                    }
                                                                                                                                                                }
                                                                                                                                                            }
                                                                                                                                                        }
