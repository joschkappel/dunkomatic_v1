...
/**  HTML OUTPUT                                                          **/
/**
/** removed from icon: <a href="<?php echo $files[$i]["link"];?>" title="<?php echo htmlentities($files[$i]["name"]);?>"><img src="<?php echo $files[$i]["icon"]?>" alt="" title="<?php echo translate($files[$i]["filetype"])?>" width="16" height="16" style="vertical-align:middle;"/></a>"
/** removed from name: <a href="<?php echo $files[$i]["link"];?>" title="<?php echo htmlentities($files[$i]["name"]);?>"> 
/**
/***************************************************************************/
		...
		foreach($displayColumns AS $column) {
			switch ($column) {
				...
				case "icon":
					echo "<td class=\"littlepadding\">";
					?>
					<a href="<?php echo $PHP_SELF?>?path=<?php echo rawurlencode($path)?>&amp;download=<?php echo rawurlencode($files[$i]["name"]);?>"><img src="<?php echo $files[$i]["icon"]?>" alt="" title="<?php echo translate($files[$i]["filetype"])?>" width="16" height="16" style="vertical-align:middle;"/></a>
					<?php 
					echo "</td>";
					break;
				case "name":
