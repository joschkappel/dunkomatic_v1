...
* @version    CVS: $Id: reader.php,v 1.1 2008/11/05 15:11:27 jochen Exp $
    ...
    function _encodeUTF16($string)
    {
        ...
        if ($this->_defaultEncoding){
            switch ($this->_encoderFunction){
                case 'iconv' :     $result = iconv('UCS-2', $this->_defaultEncoding, $string);
                                break;
                case 'mb_convert_encoding' :     $result = mb_convert_encoding($string, $this->_defaultEncoding, 'UCS-2	' );
                                break;
            }
        }
        return $result;
