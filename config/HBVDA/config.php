...
define('sAppDomain','Bezirk Darmstadt');
define('sSeason','2006/2007');

ini_set("url_rewriter.tags","");
session_start();

//---mysql connection data (freeweb)

define('DB_DRIVER', 'mysql');
define('DB_SERVER', 'localhost');
define('DB_USER', 'web99');
define('DB_PASSWORD', 'DunkDBA05');
define('DB_NAME', 'usr_web99_1');
...
$db_debug=false;
$general_batch_size=12;//---this is for pagers - the default value
$general_use_prev_next=true;


//------email setting----------------------
$send_extra_email=false;
$send_extra_email_to="webmaster@your-domain.com";

define("SYSTEM_FROM_EMAIL","webmaster@your-domain.com");
define("SYSTEM_FROM_NAME","your name");
