...
include( $APLICATION_ROOT.'common/db2xls/db_sxlsgen.php' );
	...
	$sql2 = 'SELECT c.shortname, c.name, c.club_no, m.lastname, m.firstname, m.street, m.zip, m.city, m.email, m.phone1, m.phone2, m.mobile, m.fax1, m.email2 FROM member as m, club as c WHERE m.member_role_id = 0 AND m.club_id=c.club_id ORDER BY c.shortname';
