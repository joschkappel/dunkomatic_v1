...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			...
			?>
			body.snif {
				background: #F5F5F5;             /* background behind table */
			}
			table.snif {
				border: 1px solid #660000;       /* main table border style */
			}
			td.snDir {
			...
			tr.snEven {
				...
				border: 1px solid #660000;
				padding: 4px;
				margin: 0px;       /* file listing background color for even numbered rows */
			}
			tr.snOdd {
				font-family: Arial, Helvetica, sans-serif;
				font-size: 11px;
				...
				padding: 4px;
				margin: 0px;
				background-color: #C9C9E4;      /* file listing background color for odd numbered rows */
			}
			tr.snF td {
