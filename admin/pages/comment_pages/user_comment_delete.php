...
include_once($ROOT.'languages/'.$application_language.'/user_comment_lang.php');
...
include_once("user_comment_definition.inc.php");

$actions_arr=array();
$actions_arr[]=array("heading"=>DELETE_APPROVE ,"onclick"=>"document.delete_form.submit();","row_end"=>false);
...
include($APLICATION_ROOT."templates/common_tpl/delete.php");
//----------------definitions end--------------
