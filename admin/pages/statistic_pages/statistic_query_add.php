...
//----------------pager definitions--------------
$handler_name="statistic_query_handler";
$handler_path="objects/common_objects/";

include_once("statistic_query_definition.inc.php");

if (isset($_SESSION["statistic_query_error"]))
{
	$error_message=$_SESSION["statistic_query_error"];
	unset($_SESSION["statistic_query_error"]);
}
